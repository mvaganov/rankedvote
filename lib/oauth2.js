...
// <DEBUG>
// lets find out what the profile gives us...
//function printPropertiesOf(obj) { console.log("----"); for (var k in obj) { if(obj.hasOwnProperty(k)) { console.log(k+" ("+typeof(obj[k])+"): "+obj[k]); } } }
//printPropertiesOf(profile);
// </DEBUG>  
  var imageUrl = '', email = '';
  ...
  if(profile.emails && profile.emails.length) {
    ...
    for(var i=0;i<profile.emails.length;++i) {
      if(profile.emails.type == "account"){ acctIndex=i;break; }
    }
    email = profile.emails[acctIndex].value;
  }
  var userProfile = {
    id: profile.id,
